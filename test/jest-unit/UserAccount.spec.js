...
describe('the UserAccount module', () => {
    ...
    mockfetch = function (url, data) {
      ...
      return Promise.resolve({
        ...
        json: () => Promise.resolve([{
          _id: '12345', first_name: 'bob', last_name: 'jones', affiliation: 'self', expertise: 'fish', interests: 'fishing', email: 'bob@smith.com'
        }])
      });
    };
    ua.fetch = mockfetch;
  ...
  it('it updates user with the user prefs form', () => {
    ...
    ua.fetch = mockfetch;
    document.body.innerHTML = '<div><div class="home"></div></div><div class="UserProfileForm" style="display:block">' +
    '<input class="uprofFirstName" value="Bob"><input class="uprofLastName" value="Smith">' +
    '<input class="uprofAff" value="self"><input class="uprofexpertise" value="dog">' +
