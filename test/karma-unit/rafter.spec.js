...
describe('The Rafter Dashboard', () => {
  ...
  it('continues to check for expired token when there is a user defined', (done) => {
    ...
    document.body.innerHTML = '<div class="rafterLogout"></div>';
    rd.attached();
